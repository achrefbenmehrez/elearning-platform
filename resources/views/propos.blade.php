            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="wm-breadcrumb">
                        <ul>
                            <li><a href="{{ route('home') }}">Accuel</a></li>
                            <li><a>Contact</a></li>
        ...
        <div class="wm-main-section whowe-are-full">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-6"> <figure class="wm-figure-thumb"><img src="{{ asset('extra-images/whowe-are-1.jpg') }}" alt=""></figure> </div>
                    <div class="col-md-6 wm-editore-text">
                        ...
                        <ul>
                            <li><i class="fas fa-check"></i> Training in rigorous analysis</li>
                            <li><i class="fas fa-check"></i> Highly developed practical competence</li>
                            <li><i class="fas fa-check"></i> Excellent basis for a wide range of careers</li>
                        </ul>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="wm-parallex wm-parallex-three">
                            <h2>Enroll University is the Best</h2>
                            <span>We promise you won’t be dissapointed!</span>
                            <a class="wm-transparent-button" href="#"><span>Enroll Today</span></a>
                        </div>
                    </div>
                        ...
                        <ul>
                            <li class="col-md-4">
                                ...
                                <div class="wm-right-section">
                                    <h2>Apply Today to Conservatory</h2>
        ...
        <div class="wm-main-section wm-studentslove-full">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-12"> <div class="wm-fancy-title"> <h2>Why Students <span>Love Us</span></h2> </div> </div>
                    <div class="col-md-6"> <video src="{{ asset('build/echo-hereweare.mp4') }}" poster="build/echo-hereweare.jpg" controls="controls" preload="none"></video> </div>
                    <div class="col-md-6">
                        <div class="wm-recent-list-slider wm-recent-list-slider-color">
                            <div class="wm-recent-list-layer">
                                <figure><a href="#"><img src="{{ asset('extra-images/recent-list-1.jpg') }}" alt=""></a></figure>
                            ...
                            <div class="wm-recent-list-layer">
                                <figure><a href="#"><img src="{{ asset('extra-images/recent-list-2.jpg') }}" alt=""></a></figure>
                                <div class="wm-recent-list-text">
                            ...
                            <div class="wm-recent-list-layer">
                                <figure><a href="#"><img src="{{ asset('extra-images/recent-list-3.jpg') }}" alt=""></a></figure>
                                <div class="wm-recent-list-text">
