                    ...
                    <div class="container">
                        <form id="contact-form" role="form">
                            <div class="controls">
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group"> <label for="nom_utilisateur" class="font-weight-bold">Nom: </label> <h5>{{ $categorie->nom }}</h5> </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-6">
                                        <a href="{{ route('admin.categories.edit', $categorie->id) }}" type="submit" class="btn btn-success btn-send pt-2 btn-block ">Modifier</a>
                                    </div>
                                    <div class="col-md-6">
                                        <form id="deleteuser" action="{{ route('admin.categories.destroy', $categorie->id) }}" method="POST">
                                            @csrf
                                            @method('DELETE')
