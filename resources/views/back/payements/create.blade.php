                                ...
                                <div class="controls">
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <div class="form-group"> <label for="email">Formation ID (Voir table formations) *</label> <input id="email" type="text" name="formation_id" class="form-control" placeholder="Formation ID *" required="required" data-error="Lastname is required."> </div>
                                            ...
                                            <div class="form-group"> <label for="password">Montant *</label> <input id="password" type="text" name="montant" class="form-control" placeholder="Montant *" required="required" data-error="Lastname is required."> </div>
                                        </div>
                                    </div>
                                    <div class="row">
