                                ...
                                <div class="controls">
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <div class="form-group"> <label for="nom_utilisateur">Titre *</label> <input id="nom_utilisateur" type="text" name="title" class="form-control" placeholder="Titre *" required="required" data-error="Firstname is required."> </div>
