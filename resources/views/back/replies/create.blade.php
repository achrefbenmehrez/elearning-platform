                        ...
                        @endif
                            <form id="contact-form" role="form">
                                <div class="controls">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group"> <label for="nom_utilisateur">writer ID(voir table utilisateurs) *</label> <input id="nom_utilisateur" type="text" name="user_id" class="form-control" placeholder="User id *" required="required" data-error="Firstname is required."> </div>
                                            <div class="form-group"> <label for="nom_utilisateur">discussion ID(voir table discussions) *</label> <input id="nom_utilisateur" type="text" name="discussion_id" class="form-control" placeholder="Discussion id *" required="required" data-error="Firstname is required."> </div>
                                            <div class="form-group">
                                                <label for="nom_utilisateur">Contenu *</label>
                                                <input type="text" class="form-control" name="content" id="x" hidden/>
