...
class AbonnementController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('back.abonnements.index', compact('abonnements'));
    }
    ...
    {    $roles = Role::all();
        ...
        return view('back.abonnements.create',compact('roles'));
    }
    ...
    public function show($id)
    {
        ...
        return view('back.abonnements.show',compact('abonnement')) ;
    }
